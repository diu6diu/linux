...
static const struct display_timing timing_5x5_720x1280 = {
	.pixelclock = {.min = 65000000, .typ = 65000000, .max = 65000000,},
	.hactive = {.min = 720, .typ = 720, .max = 720,},
	.hfront_porch = {.min = 48, .typ = 48, .max = 48,},
	.hback_porch = {.min = 52, .typ = 52, .max = 52,},
	.hsync_len = {.min = 8, .typ = 8, .max = 8,},
	.vactive = {.min = 1280, .typ = 1280, .max = 1280,},
	.vfront_porch = {.min = 16, .typ = 16, .max = 16,},
	.vback_porch = {.min = 15, .typ = 15, .max = 15,},
...
static int atk_panel_get_display_timing(int lcd_id,
    ...
    case ATK_7_1024x600 :
        ...
        break;
    case ATK_5x5_720x1280 :
		memcpy(timings, &timing_5x5_720x1280, sizeof(*timings));
        break;
